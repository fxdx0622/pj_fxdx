...
/// </summary>
public class AllDissolveFadeController : MonoBehaviour
{
...
[CustomEditor(typeof(AllDissolveFadeController))]
public class DissolveFadeControllerEditor_v2 : Editor
{
	public override void OnInspectorGUI()
	{
		...
		if (Application.isPlaying)
		{
			...
			{
				((AllDissolveFadeController)target).PlayDissolveFade();
			}
		}
		else
		{
