...
[CustomEditor(typeof(CustomDepthOfField))]
public class CustomDepthOfFieldEditor : VolumeComponentEditor
{
	...
	{
		var o = new PropertyFetcher<CustomDepthOfField>(serializedObject);
	...
	public override void OnInspectorGUI()
	{
		...
		if (m_Mode.value.intValue == (int)CustomDepthOfFieldMode.Gaussian)
		{
		...
		else if (m_Mode.value.intValue == (int)CustomDepthOfFieldMode.Bokeh)
		{
